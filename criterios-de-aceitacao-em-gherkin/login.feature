            ...
            Cenário: Bloquear o login caso o usuário erre a senha 3 vezes
            Quando o usuário errar a senha 3 vezes
            Então o login deve ser bloqueado por 15 minutos

            Esquema do Cenário: Fazer login com sucesso caso o usuário e a senha sejam válidos
            ...
            Esquema do Cenário: Exibir uma mensagem de erro caso o usuário ou a senha estejam incorretos
